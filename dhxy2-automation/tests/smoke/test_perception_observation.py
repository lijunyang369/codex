...
class ObservationBuilderTestCase(unittest.TestCase):
    ...
    def test_build_sets_battle_flags_from_template_ids(self) -> None:
        matches = (
            MatchResult(template_id="battle_ui", confidence=0.96, region_name="battle_main"),
        ...
        ocr_lines = (OCRResult(text="第1回合", confidence=0.88, region_name="battle_prompt"),)
        ...
        observation = self.builder.build(
            ...
            matches=matches,
            ocr_texts=ocr_lines,
            named_regions={"battle_prompt": Rect(10, 10, 100, 40)},
        )
        ...
        self.assertAlmostEqual(0.92, observation.confidence_summary, places=2)
