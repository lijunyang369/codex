            ...
            app = BattleAutomationApp(
                ...
                observation_provider=SequenceObservationProvider(
                    [
                        ...
                        build_observation(battle_ui_visible=True, action_prompt_visible=False, skill_panel_visible=False, round_number=None),
                        build_observation(battle_ui_visible=True, action_prompt_visible=False, skill_panel_visible=False, round_number=None),
                        build_observation(battle_ui_visible=True, action_prompt_visible=True, skill_panel_visible=True, round_number=2),
                        build_observation(battle_ui_visible=False, action_prompt_visible=False, skill_panel_visible=False, round_number=None),
                    ]
                ),
